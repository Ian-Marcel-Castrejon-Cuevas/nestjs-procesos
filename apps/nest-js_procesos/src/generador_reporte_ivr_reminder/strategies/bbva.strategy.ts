...
@Injectable()
/**
 * Estrategia BBVA para generación de reportes (implementación concreta).
 */
export class BbvaStrategy extends BaseReportStrategy {
  constructor(logger: ReportLoggerService) {
    const config: StrategyConfig = {
      type: REPORT_TYPES.BBVA,
      searchText: REPORT_CONFIGS[REPORT_TYPES.BBVA].searchText,
      filenamePrefix: REPORT_CONFIGS[REPORT_TYPES.BBVA].filenamePrefix,
    };
    super(config, logger);
  }
